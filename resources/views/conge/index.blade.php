            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Liste des conges</h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}"><i class="feather icon-home"></i></a></li>
                        <li class="breadcrumb-item"><a href="{{ route('conge.index') }}">Les conges</a></li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <table id="simpletable" class="table table-striped table-bordered nowrap">
                            ...
                            <tbody>
                               ...
                               <tr>
                                ...
                                <td>{{ $conge->mobilite->nom }}</td>
                                <td>{{  Carbon\Carbon::parse( $conge->datedebut)->format('d-m-Y')  }}</td>
                                <td>{{ Carbon\Carbon::parse($conge->datefin)->format('d-m-Y')  }}</td>
                                 <td>{{--  <a href="{{ route('conge.show', $conge->id) }}" role="button" class="btn btn-primary"><i class="fas fa-eye"></i></a>  --}}
                                 <a href="{{ route('conge.edit', $conge->id) }}" role="button" class="btn btn-warning"><i class="fas fa-edit"></i></a>
