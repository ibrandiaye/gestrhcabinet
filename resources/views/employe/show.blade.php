...
<div class="pcoded-content">
    ...
    <div class="row">
                ...
                <div class="card-body border-top pro-det-edit collapse show" id="pro-det-edit-1">
                    <form>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <a href="{{ asset('diplome/'.$employe->diplome) }}">Diplôme</a>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-6 col-form-label font-weight-bolder">CV</label>
                            <div class="col-sm-6">
                                <a href="{{ asset('cv/'.$employe->cv) }}">CV</a>
                            </div>
                        </div>
                        <div class="form-group row">
        ...
        @if($employe->autorisations)
        @foreach ($employe->autorisations as $key=> $autorisation)
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body d-flex align-items-center justify-content-between">
